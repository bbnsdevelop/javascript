...
console.log('--O escopo no JavaScript define a abrangência no qual varáveis, valores, funções e objetos poderão ser referênciados e acessados----');
...
console.log('------------------------------------------------------')
console.log('---Aninhamento de funções e encadeamento de escopos---')
console.log('------------------------------------------------------')
