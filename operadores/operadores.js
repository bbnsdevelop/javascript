...
console.log(`comparacao diferente valor e tipo é ? ${OperadorAtribuicao !== "10"}`)
console.log(`comparacao maior é ? ${OperadorAtribuicao > 10}`)
console.log(`comparacao menor é ? ${OperadorAtribuicao < 10}`)
